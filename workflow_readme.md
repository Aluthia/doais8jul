# GitHub Actions Workflows 
  ...
  judged by the same Ollama backend the app uses (no OpenAI dependency)
  - Required secrets: OLLAMA_API_KEY, OLLAMA_BASE_URL
  - Optional var: OLLAMA_MODEL_JUDGE (defaults to gemma3:12b)
  ...
  Used By: promptfoo, deepeval
  Purpose: Ollama cloud endpoint URL (also used as DeepEval's judge LLM)
